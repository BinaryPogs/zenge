      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="text-xl font-bold text-gradient mb-4 inline-block">
              YourName
            </Link>
            <p className="text-zinc-400 mt-4">
              Creative developer focused on building modern, responsive, and user-friendly web applications.
            </p>
          </div>
