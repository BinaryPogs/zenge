      ...
      <div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <a href="mailto:hello@yourname.com" className="text-emerald-400 hover:underline">
              hello@yourname.com
            </a>
          </div>
          ...
          >
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
              />
            </div>
